...
Since opposition to the death penalty and opposition to using military force in international conflict are both pro-life attitudes, and opposition to abortion rights reduction is an anti pro-life attitude, a significant positive correlation between these variables would support my hypothesis that pro-life attitudes are not consistent between abortion and other issues. Since opposition to banning assault rifles is an anti pro-life attitude, just like opposition to abortion rights reduction, a significant negative correlation here would support my hypothesis that pro-life attitudes are not consistent between abortion and other issues. A significant negative correlation between degree of conservative identification and opposition of abortion right reduction would further support my hypothesis that the pro-life argument for abortion is not based in values, but instead a partisan identification or political argument. However, if there were significant correlations found in the other direction, this would suggest that pro-life attitudes are consistent among many political issues, and that the pro-life abortion argument is a true, consistent value, which I believe would give it more merit, as opposed to just political rhetoric. If we fail to reject the null hypothesis altogether and find no significant correlations, perspectives on these issues may not be related at all (somewhat supporting the hypothesis that pro-life is primarily rhetoric), or that there are a multitude of motivations driving opinions on these topics. 
