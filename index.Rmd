...
Outcome variable and measurement: Favoring of abortion rights
...
It is important to note that scoring highly on the outcome variable would imply a pro-choice attitude (anti-pro-life attitude), not pro-life attitude. For that reason, when analyzing the data _____. 
...
4) Self-identified partisanship (higher scores equate to higher conservatism)
1. Extremely liberal
2. Liberal
3. Slightly liberal
...
If there is a significant, negative correlation with favoring the death penalty, favoring military force, or a positive correlation with favoring banning assault rifles, it would imply that pro-life attitudes are consistent across those issues. However, I hypothesize that the opposite will be true, so the opposite results (a significant, positive correlation with favoring the death penalty, favoring military force, or a negative correlation with favoring banning assault rifles) would support my hypothesis, as well as a significant negative correlation with party identification, which would suggest that conservative self-identification is correlated with anti-abortion attitudes. 
